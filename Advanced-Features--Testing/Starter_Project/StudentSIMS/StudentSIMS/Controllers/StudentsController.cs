...
namespace StudentSIMS.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        private readonly ICountryIdentifierRepository _repo;
        ...
        // GET: api/Students/5
        [HttpGet("phone/{id}")]
        public ActionResult<string> GetStudentPhoneNumberWithExtension(int id)
        {
            ...
            var phoneExtension = _repo.GetCountryExtension(student.CountryCode);
            return phoneExtension + student.phoneNumber;
        }
    }
}
